...
//delete seller products
    ...
    {  
        ...
        $totalRecordswithFilter = ProductRequest::leftJoin('buyer_companies', 'buyer_companies.user_id', '=', 'product_requests.user_id')->leftJoin("users","users.id", "=", "product_requests.parent_id")
            ...
            if ($request->input("country_id") != "") {
                ...
                $totalRecordswithFilter = $totalRecordswithFilter->where(function ($query) use (
                    ...
                    foreach ($country_id as $c_id) {
                        $query->WhereRaw( 'find_in_set("' . $c_id . '",users.country_id)');
                    }
                });
            }
